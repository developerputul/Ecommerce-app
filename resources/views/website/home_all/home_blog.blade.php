            ...
            @foreach ($blogs as $item)
                ...
                <div class="blog__post__item">
                    <div class="blog__post__thumb">
                        <a href="blog-details.html"><img src="{{asset($item->blog_image)}}" alt="" style="width:400;height:300px;"></a>
                    ...
                    <div class="blog__post__content">
                        ...
                        <h3 class="title"><a href="{{route('blog.details', $item->id)}}">{{ $item->blog_title}}</a>
                        </h3>
